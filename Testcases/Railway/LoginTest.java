...
public class LoginTest extends TestBase {
	...
	public void TC03_LoginWithInvalidPassword() {
		...
		final Account invalidPasswordAccount = new Account(Constant.USERNAME, Constant.INVALID_PASSWORD, Constant.PID);
	    final String expectedMsg = "There was a problem with your login and/or errors exist in your form.";
	...
	public void TC05_LoginWithNotActivatedAccount() {
		...
		final Account notActivatedAccount = new Account(Constant.NOT_ACTIVATED_USERNAME, Constant.PASSWORD, Constant.PID);
	...
	public void TC06_RedirectToHomeAfterLogout() {
	    ...
	    FAQPage faqPage = homePage.gotoPage(TabMenu.FAQ,FAQPage.class);
	    
	    System.out.println("4. Click on 'Log out' tab");
	    homePage = faqPage.gotoPage(TabMenu.LOGOUT,HomePage.class);
